...
test_labeled.c.bin:     file format elf64-x86-64
...
int main() {
  int result = factorial(10);
    1040:	bf 0a 00 00 00       	mov    $0xa,%edi
    1045:	e9 f6 00 00 00       	jmp    1140 <factorial>
...
0000000000001140 <factorial>:
  if (n <= 1) return 1;
    ...
    1145:	83 ff 01             	cmp    $0x1,%edi
    1148:	7e 11                	jle    115b <factorial+0x1b>
